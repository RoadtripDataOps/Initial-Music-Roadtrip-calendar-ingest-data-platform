# JamBase API Reference (Legacy v1 Archive)

This file is retained as an older v1 research archive only. Current provider
pipeline metadata should use JamBase API v3.1.0 from
`docs/provider-research/jambase/v3.1.0/` and the summary in
...
- Legacy v1 base URL: `https://www.jambase.com/jb-api/v1`
